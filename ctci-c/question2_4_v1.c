...
struct node * sortAroundVal(struct node *start, struct node *head, int val) {
	...
	while (curr!= NULL) {
		if (curr->data < val) {
			head = addNodetoFront(head, curr->data);
		}
...
int main(int argc, char *argv[]) {
	...
	*/
	...
	//int arr[MAX_LEN] = {5,60,14,50,9,10,5,14,130,14,0,1,2,15,4};
